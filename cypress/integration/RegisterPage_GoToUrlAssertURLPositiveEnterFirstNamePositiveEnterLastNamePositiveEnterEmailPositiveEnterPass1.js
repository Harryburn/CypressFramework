...
cy.xpath("//*[@id='firstname']").type("excepturi")

cy.xpath("//*[@id='lastname']").type("Ankunding")

cy.xpath("//*[@id='email_address']").type("james.walker@curiosity.software")

cy.xpath("//*[@id='password']").type("K9rbtfL60m")

cy.xpath("//*[@id='password-confirmation']").type("8jMkpjj5RP")
